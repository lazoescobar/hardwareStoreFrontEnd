...
import styles from './formularioBusquedaProducto.module.css';
...
const FormularioBusquedaProducto : React.FC<Props> = ({contadorRecargas, recargarProductos, actualizaNombreBusqueda, actualizaTodosBusqueda}) => {
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row justify-content-center">
                                <div className="col-lg-4 text-center">
                                    <h4> <strong> Formulario búsqueda producto</strong></h4>
                                </div>
                            </div>
                            <br/>
                            <div className="row justify-content-center">
                                <div className="col-lg-4 text-center">
                                    <div className="row justify-content-center">
                                        <div className="col-lg-12 text-center">
                                            <span className={styles.subrayado}> Nombre producto </span>
                                        </div>
                                        <div className="col-lg-12 text-center">
                                            <InputField
                                            disabled={false}
...
export default FormularioBusquedaProducto;